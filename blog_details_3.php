...
<div class="Blog-area pt-100 pb-100">
    <div class="container">
        <div class="row flex-row-reverse">
            <div class="col-lg-9">
                <div class="blog_details_3-wrapper ml-20">
                    <div class="blog_details_3-top">
                        ...
                        <div class="blog_details_3-content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="dec-img mb-50">
                                    <img alt="" src="assets/img/blog/blog_details_3.jpg">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="dec-img mb-50">
                                    <img alt="" src="assets/img/blog/blog_details_3-2.jpg">
                                </div>
                            </div>
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehendrit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                    ...
                    <div class="blog-comment-wrapper mt-55">
                        ...
                        <div class="single-comment-wrapper mt-35">
                            ...
                            <div class="blog-comment-content">
                                ...
                                <div class="blog_details_3-btn">
                                    <a href="blog_details_3.php">read more</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="sidebar-widget mt-35">
                        ...
                        <div class="sidebar-widget-list mt-20">
                            <ul>
                                ...
                                <li>
                                    <div class="sidebar-widget-list-left">
                                        <input type="checkbox" value=""> <a href="#">Accessories  <span>4</span> </a>
                                        <span class="checkmark"></span>
                                    </div>
                                </li>
                            </ul>
