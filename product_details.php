                    ...
                    <div class="product-details-img">
                        <div class="tab-content jump"> 
                            <div id="shop-details-1" class="tab-pane large-img-style">
                                <img src="assets/img/product-details/product7.jpeg" alt="">
                                <span class="dec-price">-10%</span>
                                <div class="img-popup-wrap">
                                    <a class="img-popup" href="assets/img/product-details/small-product2.jpeg"><i class="pe-7s-expand1"></i></a>
                                </div>
                            </div>
                            <div id="shop-details-2" class="tab-pane active large-img-style">
                                ...
                                <span class="dec-price">-10%</span>
                                <div class="img-popup-wrap">
                                    <a class="img-popup" href="assets/img/product-details/small-product3.jpeg"><i class="pe-7s-expand1"></i></a>
                                </div>
                            </div>
                            <div id="shop-details-3" class="tab-pane large-img-style">
                                ...
                                <span class="dec-price">-10%</span>
                                <div class="img-popup-wrap">
                                    <a class="img-popup" href="assets/img/product-details/small-product4.jpeg"><i class="pe-7s-expand1"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="shop-details-tab nav">
                            <a class="shop-details-overly" href="#shop-details-1" data-toggle="tab">
                                <img src="assets/img/product-details/small-icon2.jpeg" alt="">
                            </a>
                            <a class="shop-details-overly active" href="#shop-details-2" data-toggle="tab">
                                <img src="assets/img/product-details/small-icon3.jpeg" alt="">
                            </a>
                            <a class="shop-details-overly" href="#shop-details-3" data-toggle="tab">
                                <img src="assets/img/product-details/small-icon4.jpeg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="related-product-active owl-carousel owl-dot-none">
            <div class="product-wrap">
                <div class="product-img">
                    <a href="product_details.php">
                        <img class="default-img" src="assets/img/product/shop-product1.jpeg" alt="">
                        <img class="hover-img" src="assets/img/product/shop-product1.jpeg" alt="">
                    </a>
            ...
            <div class="product-wrap">
                <div class="product-img">
                    <a href="product_details.php">
                        <img class="default-img" src="assets/img/product/shop-product2.jpeg" alt="">
                        <img class="hover-img" src="assets/img/product/shop-product2.jpeg" alt="">
                    </a>
            ...
            <div class="product-wrap">
                <div class="product-img">
                    <a href="product_details.php">
                        <img class="default-img" src="assets/img/product/shop-product3.jpeg" alt="">
                        <img class="hover-img" src="assets/img/product/shop-product3.jpeg" alt="">
                    </a>
                    <span class="pink">-10%</span>
                    <div class="product-action">
                        <div class="pro-same-action pro-wishlist">
            ...
            <div class="product-wrap">
                ...
                <div class="product-content text-center">
                    <h3><a href="product_details.php">T- Shirt And Jeans</a></h3>
                    <div class="product-rating">
                        <i class="fa fa-star-o yellow"></i>
                        <i class="fa fa-star-o yellow"></i>
                        <i class="fa fa-star-o yellow"></i>
