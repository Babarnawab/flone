        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="single-banner mb-30">
                    <a href="product_details.php"><img src="assets/img/banner/banner-1.jpg" alt=""></a>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="single-banner mb-30">
                    <a href="product_details.php"><img src="assets/img/banner/banner-2.jpg" alt=""></a>
                    <div class="banner-content">
                        <h3>Plo Bag</h3>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="single-banner mb-30">
                    <a href="product_details.php"><img src="assets/img/banner/banner-3.jpg" alt=""></a>
                    <div class="banner-content">
                        <h3>Sunglass</h3>
                        <h4>Starting at <span>$79.00</span></h4>
                        <a href="#"><i class="fa fa-long-arrow-right"></i></a>
